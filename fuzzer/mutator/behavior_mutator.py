...
from scenario_corpus.openscenario.config import EgoConfig, WeatherConfig, MapConfig, ScenarioConfig
from scenario_corpus.openscenario.waypoint_vehicle import WaypointVehicleConfig
from scenario_corpus.openscenario.ai_walker import AIWalkerConfig
from scenario_corpus.openscenario.traffic_light import TrafficLightBehaviorConfig
from scenario_corpus.openscenario.static_obstacle import StaticObstacleConfig
from agent_corpus.atomic.navigation.global_route_planner import GlobalRoutePlanner
from scenario_runner.ctn_operator import CtnSimOperator
from fuzzer.runner_base import FuzzSeed
...
class ScenarioMutator:
    ...
    def perturb_scenario(
        ...
        """Small perturbation mutation — does NOT need CARLA connection.
        Only modifies parameter values (speeds, triggers, weather, etc.)."""
        ...
        if mutated_scenario.npc_vehicles and len(mutated_scenario.npc_vehicles) > 0:
