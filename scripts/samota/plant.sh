...
# ==== Common Config ====
output_root="results/samota_plant"
run_tag="samota_plant"
max_sim_time=120.0
open_vis=false
...
# ==== Agent Config ====
agent_entry_point="agent_corpus.plant.PlanT_agent:PlanTPerceptionAgent"
agent_config_path="agent_corpus/plant/carla_agent_files/config/experiments/PlanTSubmission.yaml"
ads_venv_dir=".venvs/plant"
