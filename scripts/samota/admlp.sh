...
# ==== Common Config ====
output_root="results/samota_admlp"
run_tag="samota_admlp"
max_sim_time=120.0
open_vis=false
...
# ==== Agent Config ====
agent_entry_point="agent_corpus.tcp_admlp.admlp_b2d_agent:ADMLPAgent"
agent_config_path="agent_corpus/tcp_admlp/Bench2DriveZoo/admlp_b2d.ckpt"
ads_venv_dir=".venvs/tcp_admlp"
