...
# ==== Common Config ====
output_root="results/samota_simlingo"
run_tag="samota_simlingo"
max_sim_time=120.0
open_vis=false
...
agent_config_path="agent_corpus/simlingo/simlingo/checkpoints/epoch=013.ckpt/pytorch_model.pt"
ads_venv_dir=".venvs/simlingo"
