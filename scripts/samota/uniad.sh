...
# ==== Common Config ====
output_root="results/samota_uniad"
run_tag="samota_uniad"
max_sim_time=120.0
open_vis=false
...
# ==== Agent Config ====
agent_entry_point="agent_corpus.uniad_vad.uniad_b2d_agent:UniadAgent"
agent_config_path="agent_corpus/uniad_vad/adzoo/uniad/configs/stage2_e2e/base_e2e_b2d.py+agent_corpus/uniad_vad/Bench2DriveZoo/uniad_base_b2d.pth"
ads_venv_dir=".venvs/uniad_vad"
...
tester_type="samota"
tester_config_path="fuzzer/configs/debug_samota.yaml"
time_budget=4
population_size=4
