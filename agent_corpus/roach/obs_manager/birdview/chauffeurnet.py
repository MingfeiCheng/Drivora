...
from agent_corpus.roach.utils.traffic_light import TrafficLightHandler
...
class ObsManager():
    ...
    def get_observation(self, route_plan):
        ...
        route_in_pixel = np.array([[self._world_to_pixel(wp_trans.location)]
                                   for wp_trans, _ in route_plan[0:80]])
