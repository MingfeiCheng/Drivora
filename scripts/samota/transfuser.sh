...
# ==== Common Config ====
output_root="results/samota_transfuser"
run_tag="samota_transfuser"
max_sim_time=120.0
open_vis=false
...
# ==== Agent Config ====
agent_entry_point="agent_corpus.transfuser.agent:HybridAgent"
agent_config_path="agent_corpus/transfuser/model_ckpt/models_2022/transfuser"
ads_venv_dir=".venvs/transfuser"
