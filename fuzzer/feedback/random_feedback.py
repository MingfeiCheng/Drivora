...
class RandomFeedbackCalculator:
    """Feedback calculator for the random fuzzer — collision-proximity driven."""
    ...
    def get_default_feedback(self):
        return {
            "score": 1.0,
            "single_score": 1.0,
            # NOTE: key kept as 'mutliple_scores' for backward compat with record_logbook
    ...
    def _extract_runtime_metrics(self, runtime_results):
        """Extract max stuck time and destination distance from runtime results."""
    ...
    def evaluate(self, observation_data, oracle_result):
        ...
        # Random fuzzer: collision-proximity is the primary score
